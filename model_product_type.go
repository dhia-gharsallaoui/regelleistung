...
// ProductType Reserve product type:   * `FCR` - Frequency containment reserves (primary reserve)   * `aFRR`- Frequency restoration reserves with automatic activation (secondary reserve)   * `mFRR`- Frequency restoration reserves with manual activation (minute reserve). 
type ProductType string

// List of ProductType
const (
	A_FRR ProductType = "aFRR"
	M_FRR ProductType = "mFRR"
	FCR ProductType = "FCR"
)
