...
------------ | ------------- | ------------- | -------------
**Status** | Pointer to **int32** | Conveying the HTTP status code. | [optional] 
**Type** | Pointer to **string** | A URL to a document describing the error condition (optional, and \&quot;about:blank\&quot; is assumed if none is provided; should resolve to a human-readable document). | [optional] 
